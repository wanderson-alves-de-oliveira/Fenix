package com.wao.myx.projetoz.menu;
...
import com.wao.myx.projetoz.dao.BDEstatusFase;
import com.wao.myx.projetoz.dao.BDNave;
import com.wao.myx.projetoz.dao.BDRecompensa;
import com.wao.myx.projetoz.generico.memoria.CapituraEventosObj;
import com.wao.myx.projetoz.generico.recursos.ConvertBitimap;
import com.wao.myx.projetoz.generico.recursos.Cronograma;
import com.wao.myx.projetoz.generico.recursos.Esplosao;
import com.wao.myx.projetoz.generico.recursos.Fase;
import com.wao.myx.projetoz.generico.recursos.GirarOBJ;
import com.wao.myx.projetoz.generico.recursos.MudaTextura;
import com.wao.myx.projetoz.generico.recursos.Objeto3d;
import com.wao.myx.projetoz.generico.recursos.Vetor3;
import com.wao.myx.projetoz.index.Tartaruga;
import com.wao.myx.projetoz.modelo.EstatusFase;
import com.wao.myx.projetoz.modelo.Nave;
import com.wao.myx.projetoz.modelo.Recompensa;
...
public class TartarugaCorrida extends AppCompatActivity implements GLSurfaceView.Renderer, GLSurfaceView.OnTouchListener {
    ...
    private int tiroAtualDoF = 0;

    private int tiroAtualDoH = 0;
    ...
    private int tiroAtualDoG = 0;
    private int tiroAtualDoG2 = 0;
...
//    private float pontoDoEixoXFimm = 0;
    private boolean[] vaiPraCena = {false, false, false, false, false, false, false, false,false,false,false,false};
...
//    private Objeto3d btStart;
    ...
    private ArrayList<Objeto3d> inimigosG;
    private ArrayList<Objeto3d> inimigosG2;
...
//    }
    ...
    private ArrayList<Objeto3d> inimigosF;

    private ArrayList<Objeto3d> inimigosH;
...
//    private int timeModoE = 0;
    ...
    private boolean limparBunner = false;
...
//                        nuvens = new ArrayList<>();
                    if (inimigosF == null)
                        inimigosF = new ArrayList<>();
                    if (inimigosH == null)
                        inimigosH = new ArrayList<>();
                    if (inimigosA == null)
                    ...
                    if (inimigosG == null)
                        inimigosG = new ArrayList<>();
                    if (inimigosG2 == null)
                        inimigosG2 = new ArrayList<>();
                    if (inimigosE2 == null)
            ...
            case 5:
                ...
                if (!carregamentoDireto) {
                    ...
                    btEspecial = new Objeto3d(context, asset, "micelbt.obj", R.drawable.nota, new Vetor3(escala * 0.6f, escala * 0.6f, escala * 0.6f), "");
                ...
                Bitmap image = BitmapFactory.decodeResource(context.getResources(), R.drawable.micel); // 1

                texturaValoresBombas = ConvertBitimap.getBitmapRedondo(String.valueOf(nivelNave.getBomba() + 1),image);
            ...
            case 8:
                ...
                for (Objeto3d o : escudo ) {
                     o.setGiroPosition(new Vetor3(0, -267, 0f));
                  //    o.setPosition(new Vetor3(-1.3f, lye, lze));
            ...
            case 13:
                ...
                if (tiros0.size() < QTD_DE_TIROS && nivelNave.get_id() == 1) {
                    ...
                    switch (nivelNave.get_id() - 1) {
                        case 0:
                            tiros = tiros0;
                            ataqueEspecial.get(0).setCores(new Vetor3(1f, 0, 0));

                            break;
                        case 1:
                            tiros = tiros1;
                            ataqueEspecial.get(0).setCores(new Vetor3(0f, 1f, 0f));

                            break;
                        case 2:
                            tiros = tiros2;
                            ataqueEspecial.get(0).setCores(new Vetor3(0f, 1f, 1f));

                            break;
                        case 3:
                            tiros = tiros3;
                            ataqueEspecial.get(0).setCores(new Vetor3(0.5f, 1f, 1f));

                            break;
                        case 4:
                            tiros = tiros4;
                            ataqueEspecial.get(0).setCores(new Vetor3(1f, 0f, 1f));

                            break;
                        case 5:
                            tiros = tiros5;
                            ataqueEspecial.get(0).setCores(new Vetor3(0f, 0f, 1f));
...
//            asteroide();
    ...
    public void colorir() {
        ...
        for (Objeto3d o : inimigosG) {
            o.setCores(new Vetor3(1, 1, 1f));
        }
        for (Objeto3d o : inimigosG2) {
            o.setCores(new Vetor3(1, 1, 1f));
        }
...
//        }
    ...
    public void inimigosB() throws IOException {
        ...
        for (int p = 0; p < this.quantidadeDeElementos; p++) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosB.add(new Objeto3d(context, asset, "inimigo_pc.obj", R.drawable.inimigo, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosB"));
                inimigosB.get(p).vezes(2.0f);
            ...
            reduziTamanhoDoTiro( inimigosB.get(p));
...
//    }
    ...
    public void inimigosF() throws IOException {
        float vidaA = 270f;
        for (int p = 0; p < 1; p++) {
            char v = alfabeto.charAt(p);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosF.add(new Objeto3d(context, asset, "bossxa.obj", R.drawable.inimigof, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosF"));

                inimigosF.get(p).vezes(5.0f);


            }
            inimigosF.get(p).setValor(String.valueOf(v));
            inimigosF.get(p).setTiroNave(inimigosF.get(p).criarTiros(inimigosF.get(p), 5, asset, "tiroc.obj", R.drawable.tiroa, context.getResources()));
            inimigosF.get(p).setVida(vidaA * dificuldade);
            inimigosF.get(p).setRecoverVida(vidaA * dificuldade);
            inimigosF.get(p).setRefletir(true);
            // inimigosA.get(p).loadGLTexture();
            reduziTamanhoDoTiro( inimigosF.get(p));

            esplosaoArrayObj.add(new Esplosao(context, inimigosF.get(p), asset, context.getResources(), 0.8f, "inimigosF", p));


        }

        inimigosF.get(0).setPosition(new Vetor3(0.3f,
                DISTANCIA + 0.06f, -82));
    ...
    public void inimigosH() throws IOException {
        float vidaA = 270f;
        for (int p = 0; p < 6; p++) {
           // char v = alfabeto.charAt(p);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosH.add(new Objeto3d(context, asset, "micel.obj", R.drawable.misselx, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosH"));

              inimigosH.get(p).vezes(1.5f);


            }
            inimigosH.get(p).setValor(String.valueOf("H"));
         //   inimigosH.get(p).setTiroNave(inimigosH.get(p).criarTiros(inimigosH.get(p), 5, asset, "tiroc.obj", R.drawable.tiroa, context.getResources()));
            inimigosH.get(p).setVida(vidaA * dificuldade);
            inimigosH.get(p).setRecoverVida(vidaA * dificuldade);
            inimigosH.get(p).setRefletir(true);
            // inimigosA.get(p).loadGLTexture();
            //reduziTamanhoDoTiro( inimigosH.get(p));

            esplosaoArrayObj.add(new Esplosao(context, inimigosH.get(p), asset, context.getResources(), 0.8f, "inimigosH", p));


        }
        float r = DISTANCIA + 0.08f ;
        for (Objeto3d o :inimigosH) {


            o.setPosition(new Vetor3(  (float) ((Math.random() * 3)-1.4f),
                    r, -64));
        }
    ...
    public void inimigosA() throws IOException {
        ...
        for (int p = 0; p < 2; p++) {
            char v = alfabeto.charAt(p);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosA.add(new Objeto3d(context, asset, "inimigo_pa.obj", R.drawable.based, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosA"));

                inimigosA.get(p).vezes(2.5f);
            ...
            reduziTamanhoDoTiro( inimigosA.get(p));
...
//                DISTANCIA + 0.06f, -69));
    ...
    public void inimigosC() throws IOException {
        ...
        for (int p = 0; p < 6; p++) {
            // char v = alfabeto.charAt(p );
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosC.add(new Objeto3d(context, asset, "inimigo_pc.obj", R.drawable.inimigoc, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosC"));
                esplosaoArrayObj.add(new Esplosao(context, inimigosC.get(p), asset, context.getResources(), 0.8f, "inimigosC", p));
                inimigosC.get(p).vezes(1.5f);
            ...
            reduziTamanhoDoTiro( inimigosC.get(p));
    ...
    public void inimigosE() throws IOException {
        ...
        for (int p = 0; p < 6; p++) {
            // char v = alfabeto.charAt(p );
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosE.add(new Objeto3d(context, asset, "inimigo_pc.obj", R.drawable.inimigoeec, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosE"));
                esplosaoArrayObj.add(new Esplosao(context, inimigosE.get(p), asset, context.getResources(), 0.8f, "inimigosE", p));
                inimigosE.get(p).vezes(1.5f);
            ...
            reduziTamanhoDoTiro( inimigosE.get(p));
    ...
    public void inimigosG() throws IOException {

        float vidaCE = 10f;
        for (int p = 0; p < 6; p++) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosG.add(new Objeto3d(context, asset, "inimigoc.obj", R.drawable.inimigog, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosG"));
                esplosaoArrayObj.add(new Esplosao(context, inimigosG.get(p), asset, context.getResources(), 0.8f, "inimigosG", p));
              }

            inimigosG.get(p).setValor(String.valueOf("v"));
            inimigosG.get(p).setVida(vidaCE * dificuldade);
            inimigosG.get(p).setRecoverVida(vidaCE * dificuldade);
            inimigosG.get(p).setTiroNave(inimigosG.get(p).criarTiros(inimigosG.get(p), 1, asset, "tiroc.obj", R.drawable.tiroc, context.getResources()));
            reduziTamanhoDoTiro( inimigosG.get(p));

            inimigosG.get(p).setTipo("C");
            inimigosG.get(p).setPosition(new Vetor3(-1.5f, DISTANCIA, -63f));
            inimigosG.get(p).setRefletir(true);
        }
    }

    public void inimigosG2() throws IOException {

        float vidaCE = 10f;
        for (int p = 0; p < 6; p++) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosG2.add(new Objeto3d(context, asset, "inimigoc.obj", R.drawable.inimigogg, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosG2"));
                esplosaoArrayObj.add(new Esplosao(context, inimigosG2.get(p), asset, context.getResources(), 0.8f, "inimigosG2", p));
            }

            inimigosG2.get(p).setValor(String.valueOf("v"));
            inimigosG2.get(p).setVida(vidaCE * dificuldade);
            inimigosG2.get(p).setRecoverVida(vidaCE * dificuldade);
            inimigosG2.get(p).setTiroNave(inimigosG2.get(p).criarTiros(inimigosG2.get(p), 1, asset, "tiroc.obj", R.drawable.tiroc, context.getResources()));
            reduziTamanhoDoTiro( inimigosG2.get(p));

            inimigosG2.get(p).setTipo("C");
            inimigosG2.get(p).setPosition(new Vetor3(-1.5f, DISTANCIA, -63f));
            inimigosG2.get(p).setRefletir(true);
        }
    }
    ...
    public void inimigosC2() throws IOException {
        ...
        for (int p = 0; p < 3; p++) {
            // char v = alfabeto.charAt(p );
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosC2.add(new Objeto3d(context, asset, "heli.obj", R.drawable.inimigoee, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosC2"));
            ...
            reduziTamanhoDoTiro( inimigosC2.get(p));
    ...
    public void inimigosE2() throws IOException {
        ...
        for (int p = 0; p < 3; p++) {
            // char v = alfabeto.charAt(p );
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                inimigosE2.add(new Objeto3d(context, asset, "heli.obj", R.drawable.inimigoee, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "inimigosE2"));
            ...
            reduziTamanhoDoTiro( inimigosE2.get(p));
    ...
    public void ataqueEspecial() throws IOException {
        ...
        for (int p = 0; p < 1; p++) {
            char v = alfabeto.charAt(p);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ataqueEspecial.add(new Objeto3d(context, asset, "especial.obj", R.drawable.esppx, new Vetor3(escala * 5f, escala * 5f, escala * 5f), "AT"));
...
//                DISTANCIA + 0.03f, -69));
    ...
    public void inimigosX() throws IOException {
        ...
        for (int p = 0; p < this.quantidadeDeElementos; p++) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                reduziTamanhoDoTiro( inimigosX.get(p));
    ...
    private void reduziTamanhoDoTiro(Objeto3d obj){
    ...
    public void boss() throws IOException {
        ...
        switch (chefeDafase) {
            ...
            case 5:
                ...
                boss.get(chefeDafase).setCores(new Vetor3(1f, 1f, 1f));
                boss.get(chefeDafase).gerarPeca(asset, "helices.obj", R.drawable.inimigoee, 4f);
...
//        this.timeModoE = 0;
        ...
        if (fasex.length > 1) {
            try {
                indice = Integer.valueOf(fasex[1]);
                indiceLevel = Integer.valueOf(fasex[0]);
            }catch (Exception e){
                indiceLevel=0;
            }
        ...
        if (((fase + 1) % 10 == 0) &&  boss.get(chefeDafase)!=null) {
            int vidas = ((fase + 1) / 10) * 2000;
            boss.get(chefeDafase).setVida(vidas );
            boss.get(chefeDafase).setRecoverVida(vidas );
        }
        //    dificult--;
...
///////////////////////////////////////////
    ...
    public Double calculoarDistanciaValor(Vetor3 v, Vetor3 v2) {
         double d = Math.sqrt(Math.pow(v.x - (v2.x), 2)
                + Math.pow(v.z - (v2.z), 2)
                + Math.pow(v.y - (v2.y), 2));

        return d;
    }
    public float valorZ(double d, Vetor3 v,Vetor3 v2) {

        double zzz =Math.sqrt( (d*d)-(Math.sqrt(Math.pow(v.x - (v2.x), 2))
                - Math.pow(v.y - (v2.y), 2)))-v2.z;
            ...
            if (obj2.getPosition().z > -64.5f) {
                ...
                if (d < 5f && fogo && obj2.getOrigem().equals("Fenix2")) {
                    ...
                    if (obj.getVida() <= 0) {
                        ...
                        limparTiros(inimigosF);
                        limparTiros(inimigosH);

                        limparTiros(inimigosB);
                        limparTiros(inimigosC);
                        limparTiros(inimigosG);
                        limparTiros(inimigosG2);
    ...
    public void controle() {
        ...
        for (int i = 0; i < inimigosC.size(); i++) {
            ...
            inidiceEsquadCE(inimigosG.get(i), 0, i);
            inidiceEsquadCE(inimigosG2.get(i), 1, i);
            ...
            moverInimigoG(0, inimigosG.get(i).getTimeLineInidvidual(), i, inimigosG.get(i), 'E');
            moverInimigoG(1, inimigosG2.get(i).getTimeLineInidvidual(), i, inimigosG2.get(i), 'E');
...
//            moduloz += veloz;
            ...
            if (acionado) {
                if (ataqueEspecial.get(0).getTime() >= 12 && nivelBomba >= 0) {
                    ...
                    texturaValoresBombas = ConvertBitimap.getBitmapRedondo(String.valueOf(nivelBomba + 1),image);
                    btEspecial.LoadTexture(texturaValoresBombas);
                    if (nivelBomba >= 0)
            ...
            for (int i = nivelTiroIndex; i < nivelTiro; i++) {
                if (tiros.get(i).getTime() >= 50 || tiros.get(i).getPosition().z < -64.5f) {
...
//////////////////////////////////////////
    ...
    private void inidiceEsquadCE(Objeto3d objArray, int modo, int i) {
        if (objArray.getTimeLineInidvidual() == 0 && objArray.isAtivado() || objArray.getPosition().z <= -1000f && objArray.isAtivado()) {
            switch (modo) {
                case 0:
                    if ("inimigosG".equals(objArray.getNomeRef())) {
                        objArray.setPosition(new Vetor3(-1.3f, DISTANCIA, -60.5f));
                        objArray.setTipo("C");
                        objArray.setGiro(90);
                        objArray.setGiroPosition(new Vetor3(0,objArray.getGiro(),0));
                    }else {

                        objArray.setPosition(new Vetor3(-1.5f, DISTANCIA, -58f));
                        objArray.setTipo("C");
                    }
                ...
                case 1:
                    ...
                    if ("inimigosG2".equals(objArray.getNomeRef())) {
                        objArray.setPosition(new Vetor3(1.3f, DISTANCIA, -60.5f));
                        objArray.setTipo("D");
                        objArray.setGiro(-90);
                        objArray.setGiroPosition(new Vetor3(0,objArray.getGiro(),0));
...
//                }
        ...
        for (int p = 0; p < 6; p++) {
            if (inimigosG.size() > 0) {
                if (inimigosG.get(p).getVida() <= 0) {
                    Esplosao esp = filtro("inimigosG", p);
                    esplodirNave(inimigosG.get(p), esp);
                }
            }
            impactoTiro(ataqueEspecial, inimigosG.get(p), acionado);
            impactoTiro(tiros, inimigosG.get(p), true);
        }

        for (int p = 0; p < 6; p++) {
            if (inimigosG2.size() > 0) {
                if (inimigosG2.get(p).getVida() <= 0) {
                    Esplosao esp = filtro("inimigosG2", p);
                    esplodirNave(inimigosG2.get(p), esp);
                }
            }
            impactoTiro(ataqueEspecial, inimigosG2.get(p), acionado);
            impactoTiro(tiros, inimigosG2.get(p), true);
        }
        ...
        for (int p = 0; p < inimigosA.size(); p++) {
            ...
            moverInimigoAF(inimigosA, 0, p,tiroAtualDoA,1);
        ...
        for (int p = 0; p < inimigosH.size(); p++) {
            if (inimigosH.get(p).getVida() <= 0) {
                String finalNome = "inimigosH";
                Esplosao esp = filtro(finalNome, p);
                esplodirNave(inimigosH.get(p), esp);
            }

            moverInimigoH(0,  p);
            calculoarColisaoI(inimigosH.get(p), Fenix.get(indexNave), true);


            impactoTiro(ataqueEspecial, inimigosH.get(p), acionado);
            impactoTiro(tiros, inimigosH.get(p), true);

//            for (Objeto3d pp : inimigosH.get(p).getTiroNave()) {
//                calculoarColisaoI(pp, Fenix.get(indexNave), false);
//            }
        ...
        if (inimigosF.get(0).getVida() <= 0) {
            String finalNome = "inimigosF";
            Esplosao esp = filtro(finalNome, 0);
            esplodirNave(inimigosF.get(0), esp);
        }

        if (timeLine > 1500 && !horaDoBoss) {
            moverInimigoAF(inimigosF, 0, 0, tiroAtualDoF, 0.5f);
        }


        calculoarColisaoI(inimigosF.get(0), Fenix.get(indexNave), true);


        impactoTiro(ataqueEspecial, inimigosF.get(0), acionado);
        impactoTiro(tiros, inimigosF.get(0), true);

        for (Objeto3d pp : inimigosF.get(0).getTiroNave()) {
            calculoarColisaoI(pp, Fenix.get(indexNave), false);
        }
        ...
        if (horaDoBoss) {
          ...
          //  moverInimigoAF(inimigosF, 0, 0,tiroAtualDoF,0.2f);
                ...
                if (true) {
                    ...
                    switch (chefeDafase) {
                        case 3:
                            ...
                            moverObjFixoPadrao(pp, modoBoss, 'y', 15f, 1000,1);


                            break;
                        default:
                            moverObjFixoPadrao(pp, modoBoss, 'z', 1f, 90,1);
                            pp.setGiro(0);
                            break;
...
//058 147 236
                ...
                switch (chefeDafase) {
                    ...
                    case 3:
                        ...
                        for (Objeto3d o : boss.get(chefeDafase).getTiroNave()) {
                            ...
                            moverObjFixoPadrao(o, 0, 'y', 15f, 1000,1);
    ...
    private void moverObjFixoPadrao(Objeto3d pp, int modo, char dir, float velocidadeG, int limit,float vel) {

        switch (modo) {
            case 0:
                pp.setPosition(new Vetor3(pp.getPosition().x, pp.getPosition().getY(), pp.getPosition().z + (velocidade *vel)));
            ...
            case 1:
                ...
                break;
            case 2:
                pp.setPosition(new Vetor3(pp.getPosition().x + (velocidade *vel), pp.getPosition().getY(), pp.getPosition().z));
                girarx.girarOBJ(pp, (limit) * -1, dir, velocidadeG);
            ...
            case 3:
                ...
                break;
            case 4:
                pp.setPosition(new Vetor3(pp.getPosition().x + (velocidade *vel), pp.getPosition().getY(), pp.getPosition().z + (velocidade *vel)));
                girarx.girarOBJ(pp, (limit) * -1, dir, velocidadeG);
                if (pp.getPosition().x >= 1.1f)
                    pp.setDr(5);
                break;
            ...
            case 8:
                if (pp.getPosition().x < Fenix.get(indexNave).getPosition().x) {
                    pp.getPosition().x += (velocidade *vel) * 0.5f;
                } else {
                    pp.getPosition().x -= (velocidade *vel) * 0.5f;
    ...
    public void  moverInimigoAF(ArrayList<Objeto3d> inimigos,float giroybolhas, int p,int tiroAtual, float vel) {

        if (inimigos.get(p).isAtivado()) {
            inimigos.get(p).setAbatidoPelaNave(false);

            inimigos.get(p).setGiro(giroybolhas);
            ...
            if (inimigos.get(p).getPosition().z <= -80) {
                inimigos.get(p).getPosition().z = (float) ((-65 - p) - (Math.random() * 2));
                inimigos.get(p).getPosition().x = (float) (-1 + (Math.random() * 2));
            }


            if (inimigos.get(p).getPosition().z > -58) {


                inimigos.get(p).setPosition(new Vetor3(-0.3f,
                        DISTANCIA, -68));

                inimigos.get(p).setAbatido(true);
                inimigos.get(p).setAtivado(false);
                inimigos.get(p).setEsplodiu(false);
            } else {
                if (inimigos.get(p).getPosition().z < -59f) {
                    inimigos.get(p).setDisparando(true);
                }
            }
            if (inimigos.get(p).getPosition().z > -58) {
                inimigos.get(0).setPosition(new Vetor3(-0.2f,
                        DISTANCIA + 0.06f, -67));
                inimigos.get(1).setPosition(new Vetor3(0.3f,
                        DISTANCIA + 0.06f, -70));
//                inimigosA.get(2).setPosition(new Vetor3(0.0f,
//                        DISTANCIA + 0.06f, -69));

                inimigos.get(0).setEsplodiu(false);
                inimigos.get(1).setEsplodiu(false);
        ...
        if (inimigos.get(p).getPosition().z < -59f) {
            ...
            for (Objeto3d o : inimigos.get(p).getTiroNave()) {
                o.getPosition().z = -100;
            }
        }
        switch (inimigos.get(p).getTiroTimex()) {
            case 0:
                inimigos.get(p).setModo(0);

                break;
            case 200:
                inimigos.get(p).setModo(1);

                break;
            case 250:
                inimigos.get(p).setModo(2);

                break;
            case 350:
                inimigos.get(p).setModo(3);

                break;
            case 400:
                inimigos.get(p).setModo(0);
                inimigos.get(p).setTiroTimex(-1);
                break;
        }
        if (inimigos.get(p).getPosition().z > -64) {
            inimigos.get(p).setTiroTimex(inimigos.get(p).getTiroTimex() + 1);
            if (inimigos.get(p).getPosition().x > 1.45f) {
                inimigos.get(p).setModo(3);

            } else if (inimigos.get(p).getPosition().x < -1.45f) {
                inimigos.get(p).setModo(2);
        ...
        switch (inimigos.get(p).getModo()) {
            ...
            case 0:
                ...
                if (inimigos.get(p).getPosition().z <= -900) {
                    inimigos.get(p).setCarregamentoIndividual(true);
                }
                if (inimigos.get(p).getPosition().z < -59f) {
                    inimigos.get(p).setDisparando(true);
                } else {
            ...
            case 1:
                if (time >= 100) {
                    ...
                    if (inimigos.get(p).getDr() < direcaoX2.length - 1) {
                        inimigos.get(p).setDr(inimigos.get(p).getDr() + 1);
                    } else {
                        inimigos.get(p).setDr(0);
            ...
            case 2:
                ...
                if (inimigos.get(p).getPosition().z < Fenix.get(indexNave).getPosition().z && inimigos.get(p).getPosition().z < -63f) {
                    if (inimigos.get(p).getPosition().z < -66) {
                        inimigos.get(p).getPosition().z = -66;

                    }
                    inimigos.get(p).getPosition().z += velocidade*vel;
                } else {
                    inimigos.get(p).getPosition().z -= velocidade * (2*vel);

                }
                if (inimigos.get(p).getPosition().x > Fenix.get(indexNave).getPosition().x) {
                    inimigos.get(p).getPosition().x -= velocidade * (2*vel);
                } else {
                    inimigos.get(p).getPosition().x += velocidade * (2*vel);
        ...
        if (inimigos.get(p).getPosition().z > -59) {

            inimigos.get(p).setPosition(new Vetor3(inimigos.get(p).getPosition().x,
                    DISTANCIA + 0.03f, -65));
            inimigos.get(p).setEsplodiu(false);
            inimigos.get(p).setAbatido(true);
            inimigos.get(p).setAtivado(false);
...
//        } else {
        moverObjFixoPadrao(inimigos.get(p), inimigos.get(p).getModo(), 'y', 0, 1000,vel);
        ...
        if (!horaDoBoss) {
            //inimigosA.get(p).setDisparando(true);
            disparandoOBJ(Fenix.get(indexNave).getPosition(), inimigos.get(p), 30, true, (2*vel));

        } else {

                tipoDisparaBoss(inimigos.get(0).getTiroNave(), inimigos.get(0).getTiroNave().get(tiroAtual), 1, 0.5f);
                if (inimigos.size() > 1) {
                    tipoDisparaBoss(inimigos.get(1).getTiroNave(), inimigos.get(1).getTiroNave().get(tiroAtual), 1, 0.5f);
                }
        }
...
//               proximoIni++;
    ...
    public void moverInimigoH(float giroybolhas, int p) {
        if (inimigosH.get(p).isAtivado()) {
            inimigosH.get(p).setAbatidoPelaNave(false);

            if (inimigosH.get(p).getTimeLineInidvidual() == 0) {

                inimigosH.get(p).setPosition(new Vetor3(  (float) ((Math.random() * 3)-1.4f),
                        inimigosH.get(p).getPosition().y, -65-p));

            }


            inimigosH.get(p).setTimeLineInidvidual(inimigosH.get(p).getTimeLineInidvidual()+1);


            inimigosH.get(p).setPosition(
                    new Vetor3(inimigosH.get(p).getPosition().x,
                            inimigosH.get(p).getPosition().getY(),
                            inimigosH.get(p).getPosition().z + (velocidade*3)));

                    if (inimigosH.get(p).getPosition().z <= -990) {

                        inimigosH.get(p).getPosition().z=70f;

                    }
                    if (inimigosH.get(p).getPosition().z > -59) {
                        inimigosH.get(p).setPosition(new Vetor3((float) ((Math.random() * 3)-1.4f),
                                inimigosH.get(p).getPosition().y, -1000));

                        inimigosH.get(p).setAbatido(true);
                        inimigosH.get(p).setAtivado(false);
                        inimigosH.get(p).setEsplodiu(false);
                    }


        }
        //disparandoOBJ(Fenix.get(indexNave).getPosition(), inimigosH.get(p), 30, true, 2);
    }
    ...
    public void moverInimigoX(int modo, int time, float giroybolhas, int p) {
        ...
        if (inimigosX.get(p).isAtivado()) {
            ...
            if (inimigosX.get(p).isCarregamentoIndividual()) {
                ...
                inimigosX.get(p).setTimeLineInidvidual(0);
                switch (modo) {
            ...
            if (inimigosX.get(p).isDisparando() && modo == 1) {
                moverObjFixoPadrao(inimigosX.get(p), direcaoX2[inimigosX.get(p).getDr()], 'y', 15f, 1000,1);
            } else if (modo == 0) {
                moverObjFixoPadrao(inimigosX.get(p), 0, 'y', 15f, 1000,1);
            ...
            inimigosX.get(p).setTimeLineInidvidual(inimigosX.get(p).getTimeLineInidvidual()+1);

            if (inimigosX.get(p).getTimeLineInidvidual() > 2400) {
...
//            }
    ...
    public void moverInimigoG(int modo, int time, int i, Objeto3d obj, char tipo) {
        if (obj.isAtivado()) {
            obj.setAbatidoPelaNave(false);

            if ((time >= i * 25 && (modo == 0 || modo == 1)) ) {
                ...
                switch (modo) {
                    case 0:
                        ...
                        if (true) {
                            ...
                            if (x < distx) {
                                x += (distx*2)/180;
                                obj.setGiro((float) (obj.getGiro() - 0.4f));
                            } else {
                                obj.setAbatido(true);
                                obj.setAtivado(false);
                            }

                            Vetor3 v = new Vetor3(x,obj.getPosition().y,z);
                            double distanciaB = calculoarDistanciaValor(new Vetor3(-1*distx, this.DISTANCIA, dist), new Vetor3(0f, this.DISTANCIA, dist));
                            float novoZ = valorZ(distanciaB,v, new Vetor3(0f, this.DISTANCIA, dist));
                            obj.setGiroPosition(new Vetor3(0, obj.getGiro(), 0));
                            obj.setPosition(new Vetor3(x, obj.getPosition().getY(),novoZ ));

                            for (Objeto3d pp : obj.getTiroNave()) {
                                float xx = pp.getPosition().x;
                                if (pp.getPosition().z > -57 && (xx < -2 || xx > 2)) {
                        ...
                        if (obj.getPosition().x > distx && obj.getPosition().z > -57f) {
                            obj.setAbatido(true);
                            obj.setAtivado(false);
                        }
                        if (obj.getPosition().z < -57.5 && obj.getPosition().z > -64.5) {
                    ...
                    case 1:
                        ...
                        if (true) {
                            ...
                            Vetor3 v = new Vetor3(x,obj.getPosition().y,z);
                            double distanciaB = calculoarDistanciaValor(new Vetor3(-1*distx2, this.DISTANCIA, dist), new Vetor3(0f, this.DISTANCIA, dist));
                            float novoZ = valorZ(distanciaB,v, new Vetor3(0f, this.DISTANCIA, dist));
                            obj.setGiroPosition(new Vetor3(0, obj.getGiro(), 0));
                            obj.setPosition(new Vetor3(x, obj.getPosition().getY(),novoZ ));
                        ...
                        if (obj.getPosition().x < distx2 && obj.getPosition().z > -57f) {
                            obj.setAbatido(true);
                            obj.setAtivado(false);
                        }
                        if (obj.getPosition().z < -57.5 && obj.getPosition().z > -64.5) {
...
//            }
            ...
            if (inimigosF.size() > 0) {
                desenhar(inimigosF.get(0), "inimigosF", 0);
                inimigosF.get(0).setImpacto(false);
            ...
            if (!this.perdeu && !this.venceu) {
                for (int p = 0; p < 6; p++) {
                    ...
                    if (inimigosC.size() > 0) {
                        ...
                        desenhar(inimigosG.get(p), "inimigosG", p);
                        desenhar(inimigosG2.get(p), "inimigosG2", p);

                        inimigosC.get(p).setImpacto(false);
                        inimigosE.get(p).setImpacto(false);
                        inimigosG.get(p).setImpacto(false);
                        inimigosG2.get(p).setImpacto(false);
...
//zzzzzzzzzzz
            for (int i = 0; i < life.size(); i++) {
                life.get(i).getPosition().x = (localx+ 0.4f) * -1;
                escudo.get(i).getPosition().x = (localx + 0.37f) * -1;
            }
            ...
            if (inimigosH != null) {
                for (Objeto3d o : inimigosH) {
                    desenhar(o, "inimigosH", inimigosH.indexOf(o));
            ...
            if (Fenix.get(indexNave) != null)
                Fenix.get(indexNave).draw((GL11) gl2);

            if (inimigosA != null) {
                for (Objeto3d o : inimigosA) {
                    desenhar(o, "inimigosA", inimigosA.indexOf(o));
                }
            }
            if (inimigosB != null) {
                for (Objeto3d o : inimigosB) {
                    desenhar(o, "inimigosB", inimigosB.indexOf(o));

                }
            }
            if (inimigosC != null) {
                for (Objeto3d o : inimigosC) {
                    desenhar(o, "inimigosC", inimigosC.indexOf(o));

                }
            }
            if (inimigosX != null) {
                for (Objeto3d o : inimigosX) {
                    desenhar(o, "inimigosX", inimigosX.indexOf(o));

                }
            }
            if (inimigosC2 != null) {
                for (Objeto3d o : inimigosC2) {
                    desenhar(o, "inimigosC2", inimigosC2.indexOf(o));

                }
            }
            if (inimigosE2 != null) {
                for (Objeto3d o : inimigosE2) {
                    desenhar(o, "inimigosE2", inimigosE2.indexOf(o));

                }
            }
            if (inimigosF != null) {
                for (Objeto3d o : inimigosF) {
                    desenhar(o, "inimigosF", inimigosF.indexOf(o));
            ...
            if (inimigosG != null) {
                for (Objeto3d o : inimigosG) {
                    desenhar(o, "inimigosG", inimigosG.indexOf(o));

                }
            }
            if (inimigosG2 != null) {
                for (Objeto3d o : inimigosG2) {
                    desenhar(o, "inimigosG2", inimigosG2.indexOf(o));
            ...
            if (boss != null) {
                for (Objeto3d o : boss) {
                    desenhar(o, "boss", boss.indexOf(o));
                    try {
                        if (o.getPeca() != null)
                            o.getPeca().draw((GL11) gl2);
                    } catch (Exception e) {
                    }
    ...
    private void desenhar(Objeto3d o, String nome, int p) {
        try {
            ...
            if (!horaDoBoss) {
                switch (nome) {
                    ...
                    case "inimigosG":
                        ppp = tiroAtualDoG;
                        tiroAtualDoG++;
                        if (tiroAtualDoG >= o.getTiroNave().size())
                            tiroAtualDoG = 0;
                        DrawTiros(o, nome, ppp);
                        break;
                    case "inimigosG2":
                        ppp = tiroAtualDoG2;
                        tiroAtualDoG2++;
                        if (tiroAtualDoG2 >= o.getTiroNave().size())
                            tiroAtualDoG2 = 0;
                        DrawTiros(o, nome, ppp);
                        break;
                    case "inimigosD":
                    ...
                    case "inimigosF":
                        ppp = tiroAtualDoF;
                        tiroAtualDoF++;
                        if (tiroAtualDoF >= o.getTiroNave().size())
                            tiroAtualDoF = 0;
                        DrawTiros(o, nome, ppp);
                        break;
            ...
            if (!o.isEsplodirNave() && o.getPosition().z > -70f) {
                o.draw((GL11) gl2);
            } else {
                Esplosao esp;
                if (o.isBoss()) {
...
//        if (nome.equals("inimigosE") || nome.equals("inimigosC") || nome.equals("inimigosE2") || nome.equals("inimigosC2") || nome.equals("inimigosX") || nome.equals("boss")) {
    ...
    private void restart() {
        ...
        if (recomecar == 5) {
            ...
            resaetarTudo(inimigosF);
            resaetarTudo(inimigosH);

            resaetarTudo(inimigosB);
            resaetarTudo(inimigosC);
            resaetarTudo(inimigosG);
            resaetarTudo(inimigosG2);
...
//            timeModoE = 0;
    ...
    public void moverPersonagem(MotionEvent event) {
        ...
        if (this.yy + this.yr < this.h * 0.38 && this.yy + this.yr > (this.h * 0.16) * -1 ){//&& Fenix.get(indexNave).getPosition().z<-61f && Fenix.get(indexNave).getPosition().z>-65f) {
