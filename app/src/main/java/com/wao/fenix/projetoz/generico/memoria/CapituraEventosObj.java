package com.wao.fenix.projetoz.generico.memoria;
...
public class CapituraEventosObj {
    ...
    private Bitmap img;
    private Bitmap imgP;
    private com.wao.fenix.projetoz.generico.recursos.Objeto3d Objeto3d;
    ...
    public CapituraEventosObj(float x3d, float y3d, float x, float y, int w, int h, String valor, com.wao.fenix.projetoz.generico.recursos.Objeto3d Objeto3d) {
        this.x = x;
        this.y = y;
        this.w = w;
        this.h = h;
  ...
  this.Objeto3d=Objeto3d;
    ...
    public com.wao.fenix.projetoz.generico.recursos.Objeto3d getObjeto3d() {
        return this.Objeto3d;
    }

    public void setObjeto3d(com.wao.fenix.projetoz.generico.recursos.Objeto3d Objeto3d) {
        this.Objeto3d = Objeto3d;
    }
